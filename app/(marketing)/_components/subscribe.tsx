              ...
              <FormItem>
                ...
                focus-visible:ring-offset-0  bg-gray-200 rounded-l-3xl rounded-r-[-15px] h-12 w-60 font-semibold text-black"
                    ...
                    <Button
                      type="submit"
                      disabled={isLoading}
                      className="ml-[-10%] h-12 rounded-3xl sm:w-36
...
//                 <Input name="whatsapp-number" className="focus-visible:ring-0 
//                 focus-visible:ring-offset-0  bg-gray-200 rounded-l-3xl rounded-r-[-15px] h-12 w-60 font-semibold"/>
//                 <Button className="ml-[-10%] h-12 rounded-3xl sm:w-36">Subscribe</Button>
//             </div>
//         </div>
//     )
// }